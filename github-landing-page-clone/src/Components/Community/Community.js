...
function Community() {
  return (
    <div className="community" data-testid="community">
      <span className="community__span">Community</span>
      ...
      <div className="community__cards">
        ...
        <ReadMore
          ...
          title="Kris Nova"
          subtitle="Kris Nova quickly developed a passion for open source software. Now she gets to work on open source tooling at her day job, which includes maintaining Kubernetes Operations."
        />
        <ReadMore
